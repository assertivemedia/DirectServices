<li <?php print $attributes;?> class="<?php print $classes;?>" itemprop="name">
  <a href="<?php print in_array($item['link']['href'], array('<nolink>')) ? "#" : url($item['link']['href'], $item['link']['options']);?>" <?php echo drupal_attributes($item['link']['#attributes']); ?> itemprop="url">
